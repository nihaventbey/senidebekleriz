-- Günlük içerik keşif kuyruğu (etkinlik + gezi rehberi)
-- Deadlock olursa: dev server/cron durdurun, SQL Editor'de tek seferde çalıştırın.
...
-- 2) İndeksler (tablo oluşturulduktan sonra)
...
-- 3) RLS — DROP yerine koşullu CREATE (daha az kilit çakışması)
